...
let selectedSins = [];
let confessionHistory = JSON.parse(localStorage.getItem('childrenConfessionHistory')) || [];
...
function initApp() {
    ...
    const savedHistory = localStorage.getItem('childrenConfessionHistory');
    if (savedHistory) {
...
function saveConfession() {
    ...
    localStorage.setItem('childrenConfessionHistory', JSON.stringify(confessionHistory));
